...
const Overview = () => {
    return (
        <div className="w-[500px] h-[500px] p-10 bg-[#c791d4] text-[#512C59] font-poppins rounded-xl shadow-xl flex flex-col items-center justify-center">
            <h1 className="text-2xl font-bold text-[#564181] mb-4">
