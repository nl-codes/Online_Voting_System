...
app.get("/view_election_brief", (req, res) => {
    const sql =
        "SELECT e.topic, e.stop_time, c.photo_url, c.id FROM election_candidate ec JOIN election e ON ec.election_id = e.id JOIN candidate c ON ec.candidate_id = c.id;";
